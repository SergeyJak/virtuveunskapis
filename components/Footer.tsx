    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.grid}`}>
        ...
        <nav className={styles.column} aria-label="Footer navigation">
          <h3 className={styles.heading}>{t.footer.nav}</h3>
          <Link className={styles.link} href={withLocale('/portfolio', lang)}>{t.nav.projects}</Link>
          <Link className={styles.link} href={withLocale('/#about', lang)}>{t.nav.about}</Link>
          <Link className={styles.link} href={withLocale('/#materials', lang)}>{t.nav.materials}</Link>
          <Link className={styles.link} href={withLocale('/contacts', lang)}>{t.nav.contacts}</Link>
        </nav>
        <div className={styles.column}>
          <h3 className={styles.heading}>{t.footer.contacts}</h3>
      ...
      <div className={`container ${styles.bottom}`}>
        ...
        <span className={styles.bottomAccent}>{t.footer.accent}</span>
      </div>
    </footer>
  )
}
